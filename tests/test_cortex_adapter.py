...
class CortexAdapterTests(unittest.IsolatedAsyncioTestCase):
    async def test_question_generation_forwards_raw_prompt_web_enabled_without_client_timeout(self) -> None:
        ...
        result = await adapter.execute_question_generation(prompt="contract prompt", tier=2)
